...
async function stake() {
  ...
  const CndlToken = await RootToken.at(contracts.root.tokens.CndlToken)
  console.log({ stakeManager: stakeManager.address, CndlToken: CndlToken.address, stakeToken: await stakeManager.token() })
  console.log('Sender accounts has a balanceOf', (await CndlToken.balanceOf(accounts[0])).toString())
  CndlToken.approve(stakeManager.address, web3.utils.toWei('1000000'))
  await delay(5)
