...
/**
 * @title Candle token contract
 * @notice This contract is an ECR20 like wrapper over native ether (cndl token) transfers on the candle chain
 * @dev ERC20 methods have been made payable while keeping their method signature same as other ChildERC20s on Candle
 */
