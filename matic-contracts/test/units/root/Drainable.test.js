  ...
  describe('drain assets from Deposit Manager', async function() {
    ...
    describe('Ether', async function() {
      function testEtherDrain() {
        before(freshDeploy)
        before(async function() {
          this.CndlWETH = await deployer.deployCndlWETH()
        ...
        describe('before drain', function() {
          it('depositManager must have correct balance', async function() {
            utils.assertBigNumberEquality(await this.CndlWETH.balanceOf(this.depositManager.address), this.amount)
          })
        })
        ...
        describe('after drain', function() {
          ...
          it('depositManager must have correct balance', async function() {
            utils.assertBigNumberEquality(await this.CndlWETH.balanceOf(this.depositManager.address), this.amount.sub(this.drainAmount))
          })
