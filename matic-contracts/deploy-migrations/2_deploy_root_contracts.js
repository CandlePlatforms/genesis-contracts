...
// tokens
const CndlWETH = artifacts.require('CndlWETH')
...
module.exports = async function(deployer) {
  ...
  deployer.then(async () => {
    ...
    await deployer.deploy(StakingNFT, 'Candle Validator', 'CV')

    console.log('deploying tokens...')
    await deployer.deploy(CndlWETH)
    await deployer.deploy(TestToken, 'CNDL', 'CNDL')
    ...
    const contractAddresses = {
      root: {
        ...
        tokens: {
          CndlWETH: CndlWETH.address,
          CndlToken: TestToken.address,
